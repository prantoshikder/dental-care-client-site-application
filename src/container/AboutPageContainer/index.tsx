...
import { Award, Heart, CheckCircle, Globe, Star, Users, Shield } from 'lucide-react';
...
export default function AboutPageContainer() {
  ...
  const team = [
    { name: "Dr. Sarah Johnson", role: "Principal Dentist", specialty: "Cosmetic & Implant Dentistry" },
    { name: "Dr. Michael Chen", role: "Orthodontist", specialty: "Invisalign & Braces Expert" },
    { name: "Dr. Elena Rodriguez", role: "Pediatric Dentist", specialty: "Gentle Care Specialist" }
  ];
    ...
    <div className="pb-20">
      ...
      <section className="bg-sky-600 py-24 text-white">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-6xl font-extrabold mb-6">Excellence in Dental Care</h1>
          <p className="text-xl text-sky-100 max-w-3xl mx-auto leading-relaxed">
            Our mission is to provide high-quality dental care in a comfortable and friendly environment. We believe everyone deserves a beautiful, healthy smile.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h2 className="text-3xl md:text-5xl font-extrabold text-gray-900">Your Journey to a Perfect Smile Starts Here</h2>
              <div className="h-1.5 w-20 bg-sky-600 rounded-full"></div>
            </div>
            <p className="text-gray-600 text-lg leading-relaxed">
              Founded in 2008, SmileCare Clinic has grown from a small family practice to a state-of-the-art dental facility. We've stayed true to our roots: providing personalized, compassionate care to every member of your family.
            </p>
            <p className="text-gray-600 text-lg leading-relaxed font-medium">
              We understand that visiting the dentist can be stressful for many. That's why we've designed our clinic to be a soothing space, where technology and comfort meet.
            </p>
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="bg-gray-900 rounded-[60px] p-10 md:p-20 text-white text-center relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-8">
              <h2 className="text-3xl md:text-5xl font-bold italic">"We don't just fix teeth, we build confidence."</h2>
              <p className="text-gray-400 text-lg max-w-2xl mx-auto">
                Every smile we restore is a testament to our commitment to excellence and our passion for dental health. Join our family of happy patients today.
              </p>
              <div className="flex justify-center gap-8 pt-4">
                <div className="flex flex-col items-center gap-2">
                   <div className="w-12 h-12 bg-white/10 rounded-full flex items-center justify-center"><Shield size={24} className="text-sky-400" /></div>
                   <span className="text-xs font-bold uppercase tracking-widest text-gray-400">Trusted</span>
                </div>
                <div className="flex flex-col items-center gap-2">
                   <div className="w-12 h-12 bg-white/10 rounded-full flex items-center justify-center"><Globe size={24} className="text-sky-400" /></div>
