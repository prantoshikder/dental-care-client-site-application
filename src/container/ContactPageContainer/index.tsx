      ...
      <section className="bg-sky-600 py-24 text-white">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-sky-100 max-w-3xl mx-auto leading-relaxed">
            Have a question or ready to schedule your visit? We&apos;re here to
            help you. Reach out to us through any of the channels below.
          </p>
        </div>
      </section>
            ...
            <div className="lg:col-span-1 space-y-8">
              ...
              <div className="bg-sky-600 p-8 rounded-[40px] text-white space-y-6 shadow-xl shadow-sky-200">
                ...
                <div className="pt-4 flex items-center gap-3">
                  ...
                  <p className="text-xs font-medium text-sky-100 uppercase tracking-widest">
