      ...
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="space-y-4">
          <Link href="/" className="flex items-center gap-2 text-white">
            <div className="w-8 h-8 bg-sky-600 rounded flex items-center justify-center text-white font-bold text-lg">S</div>
            <span className="text-xl font-bold tracking-tight">SmileCare</span>
          </Link>
          <p className="text-sm leading-relaxed">
            Providing high-quality dental care with the latest technology and a patient-first approach. Your smile is our priority.
          </p>
          <div className="flex gap-4 pt-2">
            <Link href="#" className="hover:text-sky-500 transition-colors"><Share2 size={20} /></Link>
            <Link href="#" className="hover:text-sky-500 transition-colors"><Globe size={20} /></Link>
            <Link href="#" className="hover:text-sky-500 transition-colors"><MessageCircle size={20} /></Link>
          </div>
        </div>
